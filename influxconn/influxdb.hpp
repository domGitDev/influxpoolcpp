...
namespace influxdb_cpp {
    ...
    namespace detail {
        ...
        struct ts_caller;
        struct inner {
            static int http_request(int sock, const char*, const char*, const std::string&, const std::string&, const server_info&, std::string*);
    ...
    namespace detail {
        ...
        struct ts_caller : public builder {
            ...
            int post_http(int sock, const server_info& si, std::string* resp = NULL)  { return _post_http(sock, si, resp); }
        ...
        inline int inner::http_request(int sock, const char* method, const char* uri,
